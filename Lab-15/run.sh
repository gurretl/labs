...
sleep 2
docker image build -t gurretl/myubuntuapache:v1 .
sleep 2
...
sleep 2
docker image history gurretl/myubuntuapache:v1
sleep 5

echo "[4] Let's a run container for testing"
sleep 2
docker container run -itd --name=testubuntuimage -p 8080:8087 gurretl/myubuntuapache:v1
