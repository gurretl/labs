...
echo ""
echo "You can login Prometheus Web Interface through this url : $url_first-$PORT_PROM-$url_second"
echo ""
...
echo "If you lost the password run kubectl get secret --namespace metrics grafana -o jsonpath="{.data.admin-password}" | base64 --decode ; echo"
echo ""
